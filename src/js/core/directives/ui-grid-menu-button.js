(function () {
  ...
  angular.module('ui.grid')
    .service('uiGridGridMenuService', ['gridUtil', 'i18nService', 'uiGridConstants', '$timeout', function (gridUtil, i18nService, uiGridConstants, $timeout) {
      /**
       *  @ngdoc service
      ...
      var service = {
        ...
        toggleColumnVisibility: function (gridCol) {
          ...
          $timeout(function () {
            if (service.refreshQue.length === 1) {
              var refresh = service.refreshQue.pop();
              refresh(gridCol);
            } else {
              service.refreshQue.pop();
            }
